<style>
    .premium-menu {
        ...
        visibility: hidden;
        transition: transform 0.8s cubic-bezier(0.76, 0, 0.24, 1), border-radius 0.8s cubic-bezier(0.76, 0, 0.24, 1), visibility 0.8s;
    }
    ...
    .premium-menu.is-open .menu-item {
        transform: translateX(0);
        opacity: 1;
    }
    
    .premium-menu.is-open .menu-item:nth-child(1) { transition-delay: 0.1s; }
    .premium-menu.is-open .menu-item:nth-child(2) { transition-delay: 0.2s; }
    .premium-menu.is-open .menu-item:nth-child(3) { transition-delay: 0.3s; }
</style>
