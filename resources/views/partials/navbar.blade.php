        ...
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex space-x-8 items-center mt-1">
                <a href="{{ route('home') }}" 
                   ...
                   class="text-sm font-medium tracking-wide uppercase {{ request()->routeIs('home') ? 'text-gray-900 border-b-2 border-gray-900 pb-1' : 'text-gray-400 hover:text-gray-900 transition-colors pb-1' }}">
                    Home
                </a>
                <a href="{{ route('work') }}" 
                   aria-current="{{ request()->routeIs('work') ? 'page' : 'false' }}"
                   class="text-sm font-medium tracking-wide uppercase {{ request()->routeIs('work') ? 'text-gray-900 border-b-2 border-gray-900 pb-1' : 'text-gray-400 hover:text-gray-900 transition-colors pb-1' }}">
                    Work
                </a>
                <a href="{{ route('map') }}" 
                   aria-current="{{ request()->routeIs('map') ? 'page' : 'false' }}"
                   class="text-sm font-medium tracking-wide uppercase {{ request()->routeIs('map') ? 'text-gray-900 border-b-2 border-gray-900 pb-1' : 'text-gray-400 hover:text-gray-900 transition-colors pb-1' }}">
                    Live Map
                </a>
            </div>
            ...
            <div class="flex md:hidden items-center">
                <button 
                    ...
                    aria-expanded="false"
                    class="text-gray-900 hover:text-gray-500 focus:outline-none transition-colors"
                >
...
<div id="mobile-menu" class="premium-menu md:hidden flex flex-col p-8 justify-between">
    <div class="flex flex-col">
        
        <div class="flex justify-end mb-10 menu-fade">
            <button 
                id="mobile-menu-close" 
                type="button"
                aria-label="Close navigation menu"
                aria-controls="mobile-menu"
                class="text-white hover:text-gray-400 focus:outline-none p-1 rounded-full hover:bg-white/10 transition-colors"
            >
        ...
        <div class="text-gray-500 border-b border-gray-800 uppercase text-xs mb-8 pb-3 tracking-widest font-semibold menu-fade">
            Navigation
        </div>
